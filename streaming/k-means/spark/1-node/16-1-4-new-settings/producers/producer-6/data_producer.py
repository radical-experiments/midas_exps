...
NUMBER_PARTITIONS= 192  # set 1 partition per core 
...
stdout_file.write('Produce_batch,Num_Messages,Number_APoints/Msg,KB_Transfered,KB/sec,TimeStamp\n')
    ...
    for idx, num_cluster in enumerate(NUMBER_CLUSTER):
        ...
        while count_produces < NUMBER_OF_PRODUCES:
            ...
            for i in range(number_batches):
                ...
                stdout_file.write( "%d,%d,%d,%d,%.1f,%s,%s\n"%\
                                    (last_index,                                                                                           
