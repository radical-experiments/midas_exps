#!/bin/bash
#SBATCH -J hist100  # Job name
#SBATCH -o hist100.out   # Name of stdout output file(%j expands to jobId)
#SBATCH -e hist100.err   # Name of stderr output file(%j expands to jobId)
#SBATCH -p normal
