...
if __name__=="__main__":
    ...
    data_file1 = read_data('k-means-stampede-strong-16-2015-07-30T17:17:56.556967')
    data_file2 = read_data('k-means-stampede-strong-16-2015-07-30T18:33:16.900414')
    data_file3 = read_data('k-means-stampede-strong-16-2015-07-30T19:56:21.376354')
    ...
    data_file1 = read_data('k-means-stampede-strong-32-2015-07-30T13:44:06.749668')
    data_file2 = read_data('k-means-stampede-strong-32-2015-07-30T14:55:25.142131')
    data_file3 = read_data('k-means-stampede-strong-32-2015-07-30T15:49:08.736604')
    ...
    data_file1 = read_data('k-means-stampede-strong-64-2015-07-30T10:54:58.934371')
    data_file2 = read_data('k-means-stampede-strong-64-2015-07-30T11:39:22.333586')
    data_file3 = read_data('k-means-stampede-strong-64-2015-07-30T12:22:58.057844')
    ...
    data_file1 = read_data('k-means-stampede-strong-128-2015-07-30T04:41:09.802235')
    data_file2 = read_data('k-means-stampede-strong-128-2015-07-30T05:41:44.931706')
    data_file3 = read_data('k-means-stampede-strong-128-2015-07-30T10:19:10.579761')
    ...
    data_file1 = read_data('k-means-stampede-strong-256-2015-07-30T00:40:55.524700')
    data_file2 = read_data('k-means-stampede-strong-256-2015-07-30T01:20:01.836241')
    data_file3 = read_data('k-means-stampede-strong-256-2015-07-30T02:41:51.522579')
    ...
    plt.legend((FigPart112,FigPart111,FigPart110,FigPart109,FigPart108,FigPart107,
               ...
               ('Done Iter3','StageOut Iter3','Exec Iter3','StageIn Iter3',
                ...
                'Done Iter1','StageOut Iter1','Exec Iter1','StageIn Iter1'))
    plt.title('StrongScaling Characterization of K-Means RP implementation on' +\
              ' Stampede, RPv0.34')
    plt.grid(True)
    plt.xticks(index+0.5*width,('16','32','64','128','256'))
    plt.ylabel('Time in Secs')
    plt.xlabel('Number of Cores')
    plt.savefig('k-means-strong-scaling-stampede-RP034.png',dpi=800)
    plt.show()
