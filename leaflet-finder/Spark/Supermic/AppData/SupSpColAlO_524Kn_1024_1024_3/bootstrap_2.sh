...
cd /work/iparaske/radical.pilot.sandbox/SupSpColAlO_524Kn_1024_1024_3-pilot.0000
...
export PYTHONPATH=/work/iparaske/radical.pilot.sandbox/SupSpColAlO_524Kn_1024_1024_3-pilot.0000/rp_install/lib/python2.7/site-packages::/usr/local/packages/python/2.7.13-anaconda/lib/python2.7/site-packages
...
export RADICAL_PILOT_NTPHOST=159.203.158.197
...
exec /worka/work/iparaske/radical.pilot.sandbox/ve_supermic/bin/python /work/iparaske/radical.pilot.sandbox/SupSpColAlO_524Kn_1024_1024_3-pilot.0000/rp_install/bin/radical-pilot-agent-multicore.py "$1" 1>"$1.out" 2>"$1.err"
